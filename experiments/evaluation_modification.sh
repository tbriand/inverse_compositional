            ...
            for EDGEPADDING in 0 5; do
                for ROBUST_GRADIENT in 0 1 2 3 4 5; do
                    for ROBUST in 0 1 2 3 4; do
                        echo "normalization ${NORMALIZATION} edge ${EDGEPADDING} gradient ${ROBUST_GRADIENT} robust ${ROBUST}"
                        echo -e "\n normalization ${NORMALIZATION} edge ${EDGEPADDING} gradient ${ROBUST_GRADIENT} robust ${ROBUST}" >> $global_results
